...
This QB64 language implementation on NotePad++ (v.8.4.4, 64bits) uses only 3 configuration files (.xml) to be copied to the NP++ folders:
	...
	1- qb64_UDL_vX.XXX.xml - file that holds the language keywords and rules based on the User Design Language interface for NP++.
...
3) Revision Version History  -----------------------------------
	...
	Rev.01 - 17 Aug 2022.
		...
		- Updated to qb64_UDL_v0.003.xml
